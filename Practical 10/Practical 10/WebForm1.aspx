...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Label ID="lblChangingColor" runat="server" Font-Bold="True" Font-Size="30pt" Text="VVP"></asp:Label>
            <br />
            <br />
        ...
        <asp:Panel ID="Panel1" runat="server">
            ...
            <asp:Button ID="Button5" runat="server" BackColor="Green" Height="50px" OnClick="Button5_Click" Width="50px" />
            &nbsp;
